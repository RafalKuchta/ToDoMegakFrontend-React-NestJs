            ...
            <div>
                {
                    messages.map(message => (
                        <div className={message.user === user ? "message-chat-inside" : "message-chat-outside" } key={message.id}>
                            <p className={message.user === user ? "message-chat--user-inside" : "message-chat--user-outside" }>{message.user}:</p>
                            <div className={message.user === user ? "message-chat--time-inside" : "message-chat--time-outside" }>
                                <p>{message.message}</p>
            ...
            <div>
                {
                    message.map((mess, i) => (
                        <div className={mess[1] === user ? "message-chat-inside" : "message-chat-outside" } key={i}>
                            ...
                            <div className={mess[1] === user ? "message-chat--time-inside" : "message-chat--time-outside" }>
                                <p>{mess[0]}</p>
